...
import com.stkj.supermarket.base.utils.BitmapUtils;
import com.stkj.supermarket.setting.data.FacePassDateBaseMMKV;
import com.stkj.supermarket.setting.model.AddLocalFacePassInfoWrapper;
...
import com.stkj.supermarket.setting.model.SearchFacePassPeopleParams;
import com.stkj.supermarket.setting.service.SettingService;
...
public class FacePassHelper extends ActivityWeakRefHolder {
    ...
    private OnHandleFaceTokenListener onHandleFaceTokenListener;
    private OnHandleCardNumberListener onHandleCardNumberListener;
    private OnQueryLocalFacePassListener onQueryLocalFacePassListener;
    ...
    public void setOnHandleFaceTokenListener(OnHandleFaceTokenListener onHandleFaceTokenListener) {
        this.onHandleFaceTokenListener = onHandleFaceTokenListener;
    }

    public void setOnHandleCardNumberListener(OnHandleCardNumberListener onHandleCardNumberListener) {
        this.onHandleCardNumberListener = onHandleCardNumberListener;
    }

    public void setOnQueryLocalFacePassListener(OnQueryLocalFacePassListener onQueryLocalFacePassListener) {
        this.onQueryLocalFacePassListener = onQueryLocalFacePassListener;
    }
     ...
     * 查询本地人脸库单个人脸
     */
    public void searchFacePassByCardNumber(String cardNumber) {
        ...
        Observable.create(new ObservableOnSubscribe<FacePassPeopleInfo>() {
                ...
                .subscribe(new DefaultObserver<FacePassPeopleInfo>() {
                    ...
                    protected void onSuccess(FacePassPeopleInfo l) {
                        if (onHandleCardNumberListener != null) {
                            onHandleCardNumberListener.onHandleLocalCardNumber(cardNumber, l);
                        }
                    }
                    ...
                    public void onError(Throwable e) {
                        if (onHandleCardNumberListener != null) {
                            onHandleCardNumberListener.onHandleLocalCardNumberError(cardNumber);
                        }
                    }
                });
    }
     ...
     * 查询本地人脸库单个人脸
     */
    public void searchFacePassByFaceToken(String faceToken) {
        Activity activityWithCheck = getHolderActivityWithCheck();
        if (activityWithCheck == null) {
            return;
        }
        Observable.create(new ObservableOnSubscribe<FacePassPeopleInfo>() {
                ...
                .subscribe(new DefaultObserver<FacePassPeopleInfo>() {
                    @Override
                    protected void onSuccess(FacePassPeopleInfo l) {
                        if (onHandleFaceTokenListener != null) {
                            onHandleFaceTokenListener.onHandleLocalFace(faceToken, l);
                        }
                    }
                    ...
                    public void onError(Throwable e) {
                        if (onHandleFaceTokenListener != null) {
                            onHandleFaceTokenListener.onHandleLocalFaceError(faceToken);
                        }
                    }
                });
    }
     ...
     * 查询本地数据库face pass
     */
    public void queryLocalFacePass(SearchFacePassPeopleParams passPeopleParams) {
        Activity activityWithCheck = getHolderActivityWithCheck();
        if (activityWithCheck == null) {
            return;
        }
...
//                                        ,FacePassPeopleInfoDao.Properties.CardNumber.like(likeKeyword)
                ...
                .subscribe(new DefaultObserver<List<FacePassPeopleInfo>>() {
                    ...
                    protected void onSuccess(List<FacePassPeopleInfo> facePassPeopleInfoList) {
                        if (onQueryLocalFacePassListener != null) {
                            onQueryLocalFacePassListener.onQueryLocalFacePassSuccess(facePassPeopleInfoList);
                        }
                    }
                    ...
                    public void onError(Throwable e) {
                        if (onQueryLocalFacePassListener != null) {
                            onQueryLocalFacePassListener.onQueryLocalFacePassError(e.getMessage());
                        }
                    }
                });
    }
    ...
    public void requestFacePass(int inferior_type, boolean ignoreRequestFacePass) {
        ...
        paramsMap.put("mode", "CompanyMember");
                ...
                .concatMap(new Function<AddLocalFacePassInfoWrapper, ObservableSource<AddLocalFacePassInfoWrapper>>() {
                    ...
                    public ObservableSource<AddLocalFacePassInfoWrapper> apply(AddLocalFacePassInfoWrapper facePassInfoWrapper) throws Throwable {
                        ...
                        try {
                            ...
                            if (cbgFacePassHandHelper != null) {
                                Bitmap faceBitmap = BitmapUtils.stringToBitmap(facePassItemInfo.getImgData());
                                FacePassAddFaceResult addFaceResult = cbgFacePassHandHelper.addFace(faceBitmap);
    ...
    private Call<BaseNetResponse<String>> getFacePassCallback(FacePassPeopleInfo facePassItemInfo) {
        TreeMap<String, String> paramsMap = ParamsUtils.newSortParamsMap();
        paramsMap.put("mode", "DownFaceFail");
