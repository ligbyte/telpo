...
import com.stkj.supermarket.base.callback.SimpleSeekBarChangeListener;
...
public class CommonSeekProgressBar extends FrameLayout {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        if (attributeSet != null) {
            TypedArray array = context.obtainStyledAttributes(attributeSet, R.styleable.CommonSeekProgressBar);
