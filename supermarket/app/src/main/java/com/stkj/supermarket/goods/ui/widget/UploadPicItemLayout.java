...
//                    simpleCameraXFragment.setDisplayOrientation(DeviceManager.INSTANCE.getDeviceInterface().getCameraDisplayOrientation());
                    //释放人脸识别相机
                    CBGCameraHelper cbgCameraHelper = ActivityHolderFactory.get(CBGCameraHelper.class, baseActivity);
                    ...
                    simpleCameraFragment.setDisplayOrientation(DeviceManager.INSTANCE.getDeviceInterface().getCameraDisplayOrientation());
                    simpleCameraFragment.setSimpleCameraListener(new OnSimpleCameraListener() {
                        @Override
                    ...
                    baseActivity.addContentPlaceHolderFragment(simpleCameraFragment);
                }
            }
        });
