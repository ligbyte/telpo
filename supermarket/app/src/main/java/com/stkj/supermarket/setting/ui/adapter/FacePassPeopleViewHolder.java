...
public class FacePassPeopleViewHolder extends CommonRecyclerViewHolder<FacePassPeopleInfo> {
    ...
    public void initViews(View itemView) {
        tvName = (TextView) findViewById(com.stkj.supermarket.R.id.tv_name);
    ...
    public void initData(FacePassPeopleInfo data) {
        ...
        GlideApp.with(mContext)
                ...
                .placeholder(R.mipmap.icon_face_default)
                .into(ivFace);
        /**
        ...
        if (cbgCheckFaceResult == 20) {
            ...
            addFaceStatus = "入库成功";
        } else if (cbgCheckFaceResult == 3) {
            addFaceStatus = "入库失败(1)";
        } else if (cbgCheckFaceResult == 4) {
            addFaceStatus = "入库失败(2)";
        }
    ...
    public static class Factory implements CommonRecyclerViewHolder.Factory<FacePassPeopleInfo> {
        ...
        public int getLayResId() {
            return com.stkj.supermarket.R.layout.item_facepass_people_info;
        }
