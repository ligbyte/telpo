...
import com.stkj.supermarketmini.base.upload.UploadFileHelper;
import com.stkj.supermarketmini.base.utils.CommonDialogUtils;
import com.stkj.supermarketmini.goods.callback.OnAddGoodsCateListener;
import com.stkj.supermarketmini.goods.callback.OnAddGoodsSpecListener;
import com.stkj.supermarketmini.goods.callback.OnCapturePicListener;
import com.stkj.supermarketmini.goods.callback.OnDelGoodsCateListener;
import com.stkj.supermarketmini.goods.callback.OnDelGoodsSpecListener;
import com.stkj.supermarketmini.goods.callback.OnGetGoodsCateListListener;
import com.stkj.supermarketmini.goods.callback.OnGetGoodsSpecListListener;
...
public class GoodsDetailInfoLayout extends FrameLayout {
    ...
    private ImageView ivGoodsScanQrcode;
    ...
    public void init(Context context, @Nullable AttributeSet attrs) {
        ...
        ivGoodsScanQrcode = (ImageView) findViewById(R.id.iv_goods_scan_qrcode);
        ivGoodsScanQrcode.setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View v) {
                showScanGoodsCode();
            }
        ...
        if (context instanceof BaseActivity) {
            ...
            qrCodeAlertFragment.setQrCodeListener(new QrCodeListener() {
                ...
                public void onScanResult(String result) {
                    ...
                    requestQrCodeDetail(result);
                }
            });
            qrCodeAlertFragment.show(baseActivity);
        }
    }
    ...
    private void requestQrCodeDetail(String qrcode) {
        ...
        if (context instanceof BaseActivity) {
            ...
            GoodsQrCodeHelper.requestCodeDetail(qrcode, baseActivity, new OnRequestQrCodeDetailListener() {
                @Override
                public void onRequestDetailSuccess(GoodsQrCodeDetail data) {
                    baseActivity.hideLoadingDialog();
                    setGoodsName(data.getGoodsName());
                    setGoodsCode(data.getCode());
                    setGoodsPic(data.getImg());
                    setGoodsComment(data.getSpec());
                }
    ...
    public void setGoodsLayoutType(int goodsLayoutType) {
        ...
        if (layoutType == LAYOUT_TYPE_DETAIL_INFO) {
            ...
            //扫条码
            ivGoodsScanQrcode.setVisibility(GONE);
            //零售价
            ...
            //扫条码
            ivGoodsScanQrcode.setVisibility(VISIBLE);
            //零售价
