package com.stkj.supermarketmini.base.excel.impl;
...
import com.stkj.supermarketmini.base.excel.annotation.CellStyle;
import com.stkj.supermarketmini.base.excel.annotation.ExcelTable;
import com.stkj.supermarketmini.base.excel.annotation.ExcelWriteAdapter;
import com.stkj.supermarketmini.base.excel.annotation.ExcelWriteCell;
...
import com.stkj.supermarketmini.base.excel.service.IParser;
import com.stkj.supermarketmini.base.excel.service.ITabContext;
...
public class ExcelImpl implements IExcelUtils {
    ...
    public <T> void readExcelXSSF(InputStream inputStream, Class<T> aClass, IParseListener<T> listener) {
        ...
        new Thread(() -> {
            try {
                ...
                e.printStackTrace();
                handler.post(() -> listener.onParseError(new Exception(e.getMessage())));
            }finally {
                try {
                    inputStream.close();
                } catch (Throwable e) {
    ...
    public <T> void writeExcelXSSF(OutputStream outputStream, List<T> data, IWriteListener listener) {
        ...
        try {
            ...
            e.printStackTrace();
            handler.post(() -> listener.onWriteError(new Exception(e.getMessage())));
            return;
        }
        //写入数据
