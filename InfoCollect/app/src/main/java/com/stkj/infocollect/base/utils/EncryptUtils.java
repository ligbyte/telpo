...
import com.stkj.common.utils.EncodeUtils;
...
public final class EncryptUtils {
     ...
     * @return the hex string of MD5 encryption
     */
    public static String encryptMD5ToString16(final String data) {
        if (data == null || data.length() == 0) return "";
        return encryptMD5ToString(data.getBytes()).substring(8, 24);
    }
