...
import com.stkj.common.storage.MediaHelper;
import com.stkj.common.ui.dialog.AppAlertDialog;
import com.stkj.common.ui.fragment.BaseRecyclerFragment;
import com.stkj.common.ui.toast.AppToast;
import com.stkj.common.ui.widget.shapelayout.ShapeImageView;
...
public class SimpleCameraXFragment extends BaseRecyclerFragment {
    ...
    protected int getLayoutResId() {
        return R.layout.fragment_simple_camerax;
    }

    @Override
    protected void initViews(View rootView) {
        surfaceView = (PreviewView) findViewById(R.id.surface_view);
        ...
        ivClose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FragmentUtils.safeRemoveFragment(getParentFragmentManager(), SimpleCameraXFragment.this);
            }
        });
        if (canSwitchCamera) {
    ...
    private void initData() {
        cameraHelper = new CameraXHelper(mActivity);
        cameraHelper.setDisplayOrientation(displayOrientation);
        cameraHelper.prepare(surfaceView);
        cameraHelper.setCameraHelperCallback(new CameraXHelper.OnCameraHelperCallback() {
            @Override
            public void onTakePictureSuccess(String picPath) {
                if (simpleCameraListener != null) {
                    ...
                    GlideApp.with(SimpleCameraXFragment.this).load(picPath).into(ivCenter);
            ...
            public void onCaptureVideoSuccess(String videoPath) {
                if (simpleCameraListener != null) {
                    ...
                    ivCenter.setVisibility(View.VISIBLE);
                    GlideApp.with(SimpleCameraXFragment.this).load(videoPath).into(ivCenter);
