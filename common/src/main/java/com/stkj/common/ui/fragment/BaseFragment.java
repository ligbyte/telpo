...
public class BaseFragment extends Fragment {
    ...
    public void setViewVisibleOnScreen(boolean viewVisibleOnScreen) {
        isViewVisibleOnScreen = viewVisibleOnScreen;
    }

    public boolean isViewVisibleOnScreen() {
        return isViewVisibleOnScreen;
    }
}
