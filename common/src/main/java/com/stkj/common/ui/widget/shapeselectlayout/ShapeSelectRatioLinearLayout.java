package com.stkj.common.ui.widget.shapeselectlayout;
...
import com.stkj.common.ui.widget.ratiolayout.RatioLinearLayout;

/**
 * 自定义的可以设置背景
 */
public class ShapeSelectRatioLinearLayout extends RatioLinearLayout {

    private ShapeSelectLayoutHelper layoutHelper;

    public ShapeSelectRatioLinearLayout(Context context) {
        super(context);
        init(context, null);
    }

    public ShapeSelectRatioLinearLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public ShapeSelectRatioLinearLayout(Context context, AttributeSet attrs, int defStyle) {
