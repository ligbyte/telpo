package com.stkj.common.ui.widget.ratiolayout;
...
public class RatioView extends View {
    ...
    public RatioView(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public RatioView(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
