package com.stkj.common.ui.widget.slidetablayout;
...
public class AppSlideTabLayout extends RecyclerView {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attributeSet, com.stkj.common.R.styleable.AppSlideTabLayout);
