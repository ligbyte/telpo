package com.stkj.common.ui.widget.linelayout;
...
public class LineLinearLayout extends LinearLayout {
    ...
    public LineLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public LineLinearLayout(@NonNull Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
