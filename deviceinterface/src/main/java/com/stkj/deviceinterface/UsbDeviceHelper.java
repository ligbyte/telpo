...
public class UsbDeviceHelper extends ActivityWeakRefHolder {
    ...
    public UsbDeviceHelper(@NonNull Activity activity) {
        ...
        LogHelper.print("--UsbDeviceHelper--init--size: " + usbDeviceList.size() + " allDevices: " + usbDeviceMap);
    }
            ...
            if (intentAction != null) {
                ...
                if (usbDevice != null) {
                    if (intentAction.equals(UsbManager.ACTION_USB_DEVICE_ATTACHED)) {
                        LogHelper.print("--UsbDeviceHelper--attach---device: " + usbDevice);
                        ...
                        LogHelper.print("--UsbDeviceHelper--detach---device: " + usbDevice);
