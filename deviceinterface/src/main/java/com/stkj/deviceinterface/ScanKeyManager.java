...
public class ScanKeyManager {
    ...
    private boolean isFinishOnceScan = true;
    ...
    public void setFinishOnceScan(boolean finishOnceScan) {
        isFinishOnceScan = finishOnceScan;
    }

    public boolean isFinishOnceScan() {
        return isFinishOnceScan;
    }
    ...
    public void analysisKeyEvent(KeyEvent event) {
        ...
        if (event.getAction() == KeyEvent.ACTION_DOWN) {
            ...
            if (keyCode == KeyEvent.KEYCODE_ENTER) {
                ...
                LogHelper.print("---analysisKeyEvent---KEYCODE_ENTER: " + mResult.toString());
    ...
    private void checkLetterStatus(KeyEvent event) {
        ...
        if (keyCode == KeyEvent.KEYCODE_SHIFT_RIGHT || keyCode == KeyEvent.KEYCODE_SHIFT_LEFT) {
            ...
            LogHelper.print("---analysisKeyEvent---KEYCODE_SHIFT_RIGHT: " + mResult.toString());
        }
    }
