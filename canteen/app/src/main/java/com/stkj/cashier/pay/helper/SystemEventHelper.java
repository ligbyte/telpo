...
public enum SystemEventHelper {
    ...
    public void init() {
        ...
        MainApplication.mainApplication.registerReceiver(mSysEventReceiver, intentFilter);
        //移动网络信号监听
        TelephonyManager mTelephonyManager = (TelephonyManager) MainApplication.mainApplication.getSystemService(Context.TELEPHONY_SERVICE);
        mTelephonyManager.listen(mPhoneStateListener, PhoneStateListener.LISTEN_SIGNAL_STRENGTHS);
        //网络连接状况监听
        ConnectivityManager connectivityManager = MainApplication.mainApplication.getSystemService(ConnectivityManager.class);
    ...
    private void initSystemEventListener(OnSystemEventListener listener) {
        if (listener != null) {
            ...
            //获取电池电量/充电状态
            BatteryManager batteryManager = (BatteryManager) MainApplication.mainApplication.getSystemService(Context.BATTERY_SERVICE);
    ...
    public void clear() {
        ...
        MainApplication.mainApplication.unregisterReceiver(mSysEventReceiver);
    }
    ...
    public int getTypeFromNetwork(Network network) {
        ...
        ConnectivityManager connectivityManager =
                (ConnectivityManager) MainApplication.mainApplication.getSystemService(Context.CONNECTIVITY_SERVICE);
    ...
    public static int getWifiNetworkRSSILevel(int level) {
        WifiManager wifiManager = (WifiManager) MainApplication.mainApplication
    ...
    public static boolean hasSimCard() {
        TelephonyManager telMgr = (TelephonyManager) MainApplication.mainApplication.getSystemService(Context.TELEPHONY_SERVICE);
