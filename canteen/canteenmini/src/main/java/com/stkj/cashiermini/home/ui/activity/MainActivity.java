package com.stkj.cashiermini.home.ui.activity;
...
import com.stkj.cashiermini.base.callback.AppNetCallback;
...
import com.stkj.cashiermini.home.ui.adapter.HomeTabPageAdapter;
import com.stkj.cashiermini.home.ui.widget.HomeTabLayout;
...
public class MainActivity extends ImmerseActivity implements AppNetCallback {
    ...
    private void initHomeContent() {
        ...
        for (int i = 0; i < 2; i++) {
            if (i == 0) {
                HomeMenuInfo menuInfo = new HomeMenuInfo(HomeTabPageAdapter.TAB_ORDER_TAG);
                HomeTabInfo<HomeMenuInfo> paymentTabInfo = new HomeTabInfo<>();
                paymentTabInfo.setExtraInfo(menuInfo);
                paymentTabInfo.setSelectRes(R.mipmap.icon_order);
                paymentTabInfo.setUnSelectRes(R.mipmap.icon_order);
